...
const PRODUCTS: Product[] = [
  {
    ...
    path: "/damatools",
    name: "DamaTools",
    tagline: "Plataforma modular",
    desc: "Gestão de clientes, calculadoras financeiras, calendário de informes e relatórios regulatórios — desenvolvido para instituições financeiras.",
    icon: "D",
